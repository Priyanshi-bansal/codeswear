  ...
  return (
    <div className="container">
       <Head>
        ...
        <meta name="keywords" content="nextjs, Codeswear wear the code " />
        <link rel="icon" href="/favicon.ico" />
      </Head>

     
     <div>
      <img src='/Home.jpg' className='right-0' ></img>
     </div>
     <section className="text-gray-600 body-font">
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
      <h1 className="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">Wear the code from codeswear.com</h1>
      <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">Wear Whatever you want? what you want? do what you want.</p>
    </div>
